      ...
      >
        ...
        {isLoading ? (
          ...
          >
            ...
            {data.description ? (
              <Text className="text-gray-600 dark:text-slate-300 text-sm mb-4 leading-5">{data.description}</Text>
            ) : (
            ...
            <View className="flex-row items-center justify-between bg-gray-50 dark:bg-slate-950/70 border border-gray-200 dark:border-slate-800 rounded-xl p-2.5 mb-4">
              <TouchableOpacity className="flex-1 flex-row items-center justify-center py-1.5 rounded-lg mr-1 bg-transparent">
                <Ionicons name={"thumbs-up-outline"} size={18} color={"#4B5563"} />
                <Text className="text-xs font-bold ml-1.5 text-gray-700 dark:text-slate-400">
                  Kudos
                </Text>
              </TouchableOpacity>

              <TouchableOpacity className="flex-1 flex-row items-center justify-center py-1.5 rounded-lg border-x border-gray-200 dark:border-slate-800">
                <Ionicons name="chatbubble-outline" size={18} color="#4B5563" />
                <Text className="text-gray-700 dark:text-slate-400 text-xs font-bold ml-1.5">Comments</Text>
              </TouchableOpacity>
              ...
              <View>
                ...
                <View className="bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800/80 rounded-2xl p-4 space-y-3">
                  ...
                  <View className="flex-row justify-between items-center">
                    ...
                    <Text className="text-gray-900 dark:text-white text-sm font-extrabold">640 kcal</Text>
                  </View>
                </View>
              </View>
            )}
            ...
            {activeTab === "segments" && (
              <View className="bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800/80 rounded-2xl p-4 items-center justify-center py-8">
                ...
                <Text className="text-gray-900 dark:text-white font-bold text-sm mt-2">Matched Segments</Text>
                <Text className="text-gray-500 dark:text-slate-400 text-xs mt-1 text-center">
            ...
            {activeTab === "best_efforts" && (
              <View className="bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800/80 rounded-2xl p-4 items-center justify-center py-8">
                ...
                <Text className="text-gray-900 dark:text-white font-bold text-sm mt-2">Personal Records</Text>
                <Text className="text-gray-500 dark:text-slate-400 text-xs mt-1 text-center">
